...
--
-- Host: 127.0.0.1
-- Tempo de geração: 01-Dez-2022 às 15:51
...
CREATE TABLE `tb_endereco` (
  ...
  `rua` varchar(300) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bairro` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `num_casa` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cidade` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `uf` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cep` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ibge` int(50) NOT NULL,
...
--
-- Estrutura da tabela `tb_endereco_visitante`
--

CREATE TABLE `tb_endereco_visitante` (
  `id_end` int(11) NOT NULL,
  `rua` varchar(300) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bairro` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `num_casa` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Estrutura da tabela `tb_ex_veiculo`
--

CREATE TABLE `tb_ex_veiculo` (
...
--
-- Extraindo dados da tabela `tb_ex_veiculo`
--

INSERT INTO `tb_ex_veiculo` (`id_carro`, `marca`, `modelo`, `veiculo`) VALUES
(0, 'Nenhum', 'Nenhum', NULL),
(1, 'Peugeot', '106 Kid 1.0', '106 '),
(2, 'Citroen', 'Ax Gti', 'Ax '),
...
CREATE TABLE `tb_posto` (
  ...
  `cod_posto_grad` int(11) NOT NULL,
  `cod_circ` int(11) NOT NULL,
  `abrev` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `posto` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cod_forca` int(11) NOT NULL,
  `forca` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `tb_posto` (`id_posto`, `cod_posto_grad`, `cod_circ`, `abrev`, `posto`, `cod_forca`, `forca`) VALUES
(2, 1, 3, 'Mar', 'Marechal', 2, 'EB'),
(3, 2, 3, 'Gen Ex', 'General-de-Exército', 2, 'EB'),
(4, 3, 3, 'Gen Div', 'General-de-Divisão', 2, 'EB'),
(5, 4, 3, 'Gen Bda', 'General-de-Brigada', 2, 'EB'),
(6, 11, 4, 'Cel', 'Coronel', 2, 'EB'),
(7, 12, 4, 'Ten Cel', 'Tenente-Coronel', 2, 'EB'),
(8, 13, 4, 'Maj', 'Major', 2, 'EB'),
(9, 15, 4, 'Cap', 'Capitão', 2, 'EB'),
(10, 16, 4, '1º Ten', 'Primeiro-Tenente', 2, 'EB'),
(11, 17, 4, '2º Ten', 'Segundo-Tenente', 2, 'EB'),
(12, 18, 4, 'Asp', 'Aspirante-a-Oficial', 2, 'EB'),
(13, 21, 5, 'S Ten', 'Subtenente', 2, 'EB'),
(14, 22, 5, '1º Sgt', 'Primeiro-Sargento', 2, 'EB'),
(15, 23, 5, '2º Sgt', 'Segundo-Sargento', 2, 'EB'),
(16, 24, 5, '3º Sgt', 'Terceiro-Sargento', 2, 'EB'),
(17, 42, 2, 'Cb', 'Cabo', 2, 'EB'),
(18, 43, 2, 'Sd Ep', 'Soldado Engajado', 2, 'EB'),
(19, 44, 2, 'Sd Ev', 'Soldado Recruta', 2, 'EB'),
(20, 51, 2, 'TM', 'Taifeiro-Mor', 2, 'EB'),
(21, 52, 2, 'T1', 'Taifeiro-de-Primeira-Classe', 2, 'EB'),
(22, 53, 2, 'T2', 'Taifeiro-de-Segunda-Classe', 2, 'EB'),
(23, 60, 1, 'Cad', 'Cadete/AMAN', 2, 'EB'),
(24, 61, 1, 'Al', 'Aluno EsPCEx', 2, 'EB'),
(25, 64, 1, 'Al/ESA/CFS', 'Aluno ESA ou de Cent Form Sgt', 2, 'EB'),
(26, 65, 1, 'Al/CFPR', 'Aluno Cur Form Pr Res', 2, 'EB'),
(27, 66, 1, 'Al/CFC', 'Aluno CFC', 2, 'EB'),
(28, 96, 0, 'Prst Sv', 'Prestador de Serviço', 2, 'EB'),
(29, 97, 2, 'Visitante', 'Visitante', 2, 'EB'),
(30, 98, 6, 'SC', 'Servidor Civil Concursado', 2, 'EB'),
(31, 99, 6, 'FC', 'Funcionário Civil Terceirizado', 2, 'EB'),
(32, 101, 3, 'Mar Ar', 'Marechal-do-Ar', 3, 'Aer'),
(33, 102, 3, 'Ten Brig', 'Tenente-Brigadeiro', 3, 'Aer'),
(34, 103, 3, 'Maj Brig', 'Major-Brigadeiro', 3, 'Aer'),
(35, 104, 3, 'Brig', 'Brigadeiro', 3, 'Aer'),
(36, 111, 4, 'Cel', 'Coronel', 3, 'Aer'),
(37, 112, 4, 'Ten Cel', 'Tenente-Coronel', 3, 'Aer'),
(38, 113, 4, 'Maj', 'Major', 3, 'Aer'),
(39, 115, 4, 'Cap', 'Capitão', 3, 'Aer'),
(40, 116, 4, '1º Ten', 'Primeiro-Tenente', 3, 'Aer'),
(41, 117, 4, '2º Ten', 'Segundo-Tenente', 3, 'Aer'),
(42, 118, 4, 'Asp', 'Aspirante-a-Oficial', 3, 'Aer'),
(43, 121, 5, 'SO', 'Suboficial', 3, 'Aer'),
(44, 122, 5, '1S', 'Primeiro-Sargento', 3, 'Aer'),
(45, 123, 5, '2S', 'Segundo-Sargento', 3, 'Aer'),
(46, 124, 5, '3S', 'Terceiro-Sargento', 3, 'Aer'),
(47, 142, 2, 'Cb', 'Cabo', 3, 'Aer'),
(48, 143, 2, 'S1', 'Soldado-de-Primeira-Classe', 3, 'Aer'),
(49, 144, 2, 'S2', 'Soldado-de-Segunda-Classe', 3, 'Aer'),
(50, 151, 2, 'TM', 'Taifeiro-Mor', 3, 'Aer'),
(51, 152, 2, 'T1', 'Taifeiro-de-Primeira-Classe', 3, 'Aer'),
(52, 153, 2, 'T2', 'Taifeiro-de-Segunda-Classe', 3, 'Aer'),
(53, 201, 3, 'Alte', 'Almirante', 1, 'MB'),
(54, 202, 3, 'Alte Esq', 'Almirante-de-Esquadra', 1, 'MB'),
(55, 203, 3, 'V Alte', 'Vice-Almirante', 1, 'MB'),
(56, 204, 3, 'C Alte', 'Contra-Almirante', 1, 'MB'),
(57, 211, 4, 'CMG', 'Capitão-de-Mar-e-Guerra', 1, 'MB'),
(58, 212, 4, 'CF', 'Capitão-de-Fragata', 1, 'MB'),
(59, 213, 4, 'CC', 'Capitão-de-Corveta', 1, 'MB'),
(60, 215, 4, 'CT', 'Capitão-Tenente', 1, 'MB'),
(61, 216, 4, '1º Ten', 'Primeiro-Tenente', 1, 'MB'),
(62, 217, 4, '2º Ten', 'Segundo-Tenente', 1, 'MB'),
(63, 218, 4, 'GM', 'Guarda-Marinha', 1, 'MB'),
(64, 221, 5, 'SO', 'Suboficial', 1, 'MB'),
(65, 222, 5, '1º SG', 'Primeiro-Sargento', 1, 'MB'),
(66, 223, 5, '2º SG', 'Segundo-Sargento', 1, 'MB'),
(67, 224, 5, '3º SG', 'Terceiro-Sargento', 1, 'MB'),
(68, 242, 2, 'CB', 'Cabo', 1, 'MB'),
(69, 243, 2, 'SD', 'Soldado', 1, 'MB'),
(70, 244, 2, 'MN', 'Marinheiro', 1, 'MB'),
(71, 311, 4, 'Cel', 'Coronel', 5, 'CB'),
(72, 312, 4, 'Ten Cel', 'Tenente-Coronel', 5, 'CB'),
(73, 313, 4, 'Maj', 'Major', 5, 'CB'),
(74, 315, 4, 'Cap', 'Capitão', 5, 'CB'),
(75, 316, 4, '1º Ten', 'Primeiro-Tenente', 5, 'CB'),
(76, 317, 4, '2º Ten', 'Segundo-Tenente', 5, 'CB'),
(77, 318, 4, 'Asp', 'Aspirante-a-Oficial', 5, 'CB'),
(78, 321, 5, 'S Ten', 'Subtenente', 5, 'CB'),
(79, 322, 5, '1º Sgt', 'Primeiro-Sargento', 5, 'CB'),
(80, 323, 5, '2º Sgt', 'Segundo-Sargento', 5, 'CB'),
(81, 324, 5, '3º Sgt', 'Terceiro-Sargento', 5, 'CB'),
(82, 342, 2, 'Cb', 'Cabo', 5, 'CB'),
(83, 344, 2, 'Sd', 'Soldado', 5, 'CB'),
(84, 411, 4, 'Cel', 'Coronel', 4, 'PM'),
(85, 412, 4, 'Ten Cel', 'Tenente-Coronel', 4, 'PM'),
(86, 413, 4, 'Maj', 'Major', 4, 'PM'),
(87, 415, 4, 'Cap', 'Capitão', 4, 'PM'),
(88, 416, 4, '1º Ten', 'Primeiro-Tenente', 4, 'PM'),
(89, 417, 4, '2º Ten', 'Segundo-Tenente', 4, 'PM'),
(90, 418, 4, 'Asp', 'Aspirante-a-Oficial', 4, 'PM'),
(91, 421, 5, 'S Ten', 'Subtenente', 4, 'PM'),
(92, 422, 5, '1º Sgt', 'Primeiro-Sargento', 4, 'PM'),
(93, 423, 5, '2º Sgt', 'Segundo-Sargento', 4, 'PM'),
(94, 424, 5, '3º Sgt', 'Terceiro-Sargento', 4, 'PM'),
(95, 442, 2, 'Cb', 'Cabo', 4, 'PM'),
(96, 444, 2, 'Sd', 'Soldado', 4, 'PM');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_posto2`
--

CREATE TABLE `tb_posto2` (
  `cod_posto_grad` int(11) NOT NULL,
  `cod_circ` int(11) NOT NULL,
  `abrev_posto_grad` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `posto` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cod_forca` int(11) NOT NULL,
  `ord` int(11) NOT NULL,
  `forca` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
...
--
-- Extraindo dados da tabela `tb_posto2`
--

INSERT INTO `tb_posto2` (`cod_posto_grad`, `cod_circ`, `abrev_posto_grad`, `posto`, `cod_forca`, `ord`, `forca`) VALUES
(1, 3, 'Mar', 'Marechal', 2, 0, ''),
(2, 3, 'Gen Ex', 'General-de-Exército', 2, 0, ''),
(3, 3, 'Gen Div', 'General-de-Divisão', 2, 0, ''),
(4, 3, 'Gen Bda', 'General-de-Brigada', 2, 0, ''),
(11, 4, 'Cel', 'Coronel', 2, 0, ''),
(12, 4, 'Ten Cel', 'Tenente-Coronel', 2, 0, ''),
(13, 4, 'Maj', 'Major', 2, 0, ''),
(15, 4, 'Cap', 'Capitão', 2, 0, ''),
(16, 4, '1º Ten', 'Primeiro-Tenente', 2, 0, ''),
(17, 4, '2º Ten', 'Segundo-Tenente', 2, 0, ''),
(18, 4, 'Asp', 'Aspirante-a-Oficial', 2, 0, ''),
(21, 5, 'S Ten', 'Subtenente', 2, 0, ''),
(22, 5, '1º Sgt', 'Primeiro-Sargento', 2, 0, ''),
(23, 5, '2º Sgt', 'Segundo-Sargento', 2, 0, ''),
(24, 5, '3º Sgt', 'Terceiro-Sargento', 2, 0, ''),
(42, 2, 'Cb', 'Cabo', 2, 0, ''),
(43, 2, 'Sd Ep', 'Soldado Engajado', 2, 0, ''),
(44, 2, 'Sd Ev', 'Soldado Recruta', 2, 0, ''),
(51, 2, 'TM', 'Taifeiro-Mor', 2, 0, ''),
(52, 2, 'T1', 'Taifeiro-de-Primeira-Classe', 2, 0, ''),
(53, 2, 'T2', 'Taifeiro-de-Segunda-Classe', 2, 0, ''),
(60, 1, 'Cad', 'Cadete/AMAN', 2, 0, ''),
(61, 1, 'Al', 'Aluno EsPCEx', 2, 0, ''),
(64, 1, 'Al/ESA/CFS', 'Aluno ESA ou de Cent Form Sgt', 2, 0, ''),
(65, 1, 'Al/CFPR', 'Aluno Cur Form Pr Res', 2, 0, ''),
(66, 1, 'Al/CFC', 'Aluno CFC', 2, 0, ''),
(96, 0, 'Prst Sv', 'Prestador de Serviço', 2, 0, ''),
(97, 2, 'Visitante', 'Visitante', 2, 0, ''),
(98, 6, 'SC', 'Servidor Civil Concursado', 2, 0, ''),
(99, 6, 'FC', 'Funcionário Civil Terceirizado', 2, 0, ''),
(101, 3, 'Mar Ar', 'Marechal-do-Ar', 3, 0, ''),
(102, 3, 'Ten Brig', 'Tenente-Brigadeiro', 3, 0, ''),
(103, 3, 'Maj Brig', 'Major-Brigadeiro', 3, 0, ''),
(104, 3, 'Brig', 'Brigadeiro', 3, 0, ''),
(111, 4, 'Cel', 'Coronel', 3, 0, ''),
(112, 4, 'Ten Cel', 'Tenente-Coronel', 3, 0, ''),
(113, 4, 'Maj', 'Major', 3, 0, ''),
(115, 4, 'Cap', 'Capitão', 3, 0, ''),
(116, 4, '1º Ten', 'Primeiro-Tenente', 3, 0, ''),
(117, 4, '2º Ten', 'Segundo-Tenente', 3, 0, ''),
(118, 4, 'Asp', 'Aspirante-a-Oficial', 3, 0, ''),
(121, 5, 'SO', 'Suboficial', 3, 0, ''),
(122, 5, '1S', 'Primeiro-Sargento', 3, 0, ''),
(123, 5, '2S', 'Segundo-Sargento', 3, 0, ''),
(124, 5, '3S', 'Terceiro-Sargento', 3, 0, ''),
(142, 2, 'Cb', 'Cabo', 3, 0, ''),
(143, 2, 'S1', 'Soldado-de-Primeira-Classe', 3, 0, ''),
(144, 2, 'S2', 'Soldado-de-Segunda-Classe', 3, 0, ''),
(151, 2, 'TM', 'Taifeiro-Mor', 3, 0, ''),
(152, 2, 'T1', 'Taifeiro-de-Primeira-Classe', 3, 0, ''),
(153, 2, 'T2', 'Taifeiro-de-Segunda-Classe', 3, 0, ''),
(201, 3, 'Alte', 'Almirante', 1, 0, ''),
(202, 3, 'Alte Esq', 'Almirante-de-Esquadra', 1, 0, ''),
(203, 3, 'V Alte', 'Vice-Almirante', 1, 0, ''),
(204, 3, 'C Alte', 'Contra-Almirante', 1, 0, ''),
(211, 4, 'CMG', 'Capitão-de-Mar-e-Guerra', 1, 0, ''),
(212, 4, 'CF', 'Capitão-de-Fragata', 1, 0, ''),
(213, 4, 'CC', 'Capitão-de-Corveta', 1, 0, ''),
(215, 4, 'CT', 'Capitão-Tenente', 1, 0, ''),
(216, 4, '1º Ten', 'Primeiro-Tenente', 1, 0, ''),
(217, 4, '2º Ten', 'Segundo-Tenente', 1, 0, ''),
(218, 4, 'GM', 'Guarda-Marinha', 1, 0, ''),
(221, 5, 'SO', 'Suboficial', 1, 0, ''),
(222, 5, '1º SG', 'Primeiro-Sargento', 1, 0, ''),
(223, 5, '2º SG', 'Segundo-Sargento', 1, 0, ''),
(224, 5, '3º SG', 'Terceiro-Sargento', 1, 0, ''),
(242, 2, 'CB', 'Cabo', 1, 0, ''),
(243, 2, 'SD', 'Soldado', 1, 0, ''),
(244, 2, 'MN', 'Marinheiro', 1, 0, ''),
(311, 4, 'Cel', 'Coronel', 5, 0, ''),
(312, 4, 'Ten Cel', 'Tenente-Coronel', 5, 0, ''),
(313, 4, 'Maj', 'Major', 5, 0, ''),
(315, 4, 'Cap', 'Capitão', 5, 0, ''),
(316, 4, '1º Ten', 'Primeiro-Tenente', 5, 0, ''),
(317, 4, '2º Ten', 'Segundo-Tenente', 5, 0, ''),
(318, 4, 'Asp', 'Aspirante-a-Oficial', 5, 0, ''),
(321, 5, 'S Ten', 'Subtenente', 5, 0, ''),
(322, 5, '1º Sgt', 'Primeiro-Sargento', 5, 0, ''),
(323, 5, '2º Sgt', 'Segundo-Sargento', 5, 0, ''),
(324, 5, '3º Sgt', 'Terceiro-Sargento', 5, 0, ''),
(342, 2, 'Cb', 'Cabo', 5, 0, ''),
(344, 2, 'Sd', 'Soldado', 5, 0, ''),
(411, 4, 'Cel', 'Coronel', 4, 0, ''),
(412, 4, 'Ten Cel', 'Tenente-Coronel', 4, 0, ''),
(413, 4, 'Maj', 'Major', 4, 0, ''),
(415, 4, 'Cap', 'Capitão', 4, 0, ''),
(416, 4, '1º Ten', 'Primeiro-Tenente', 4, 0, ''),
(417, 4, '2º Ten', 'Segundo-Tenente', 4, 0, ''),
(418, 4, 'Asp', 'Aspirante-a-Oficial', 4, 0, ''),
(421, 5, 'S Ten', 'Subtenente', 4, 0, ''),
(422, 5, '1º Sgt', 'Primeiro-Sargento', 4, 0, ''),
(423, 5, '2º Sgt', 'Segundo-Sargento', 4, 0, ''),
(424, 5, '3º Sgt', 'Terceiro-Sargento', 4, 0, ''),
(442, 2, 'Cb', 'Cabo', 4, 0, ''),
(444, 2, 'Sd', 'Soldado', 4, 0, ''),
(1, 3, 'Mar', 'Marechal', 2, 0, ''),
(2, 3, 'Gen Ex', 'General-de-Exército', 2, 0, ''),
(3, 3, 'Gen Div', 'General-de-Divisão', 2, 0, ''),
(4, 3, 'Gen Bda', 'General-de-Brigada', 2, 0, ''),
...
CREATE TABLE `tb_veiculo` (
  `id_carro` int(11) NOT NULL,
  `id_dono` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `marca` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `modelo` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ano_car` int(10) NOT NULL,
  `cor_car` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `placa` varchar(11) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `tb_veiculo` (`id_carro`, `id_dono`, `marca`, `modelo`, `ano_car`, `cor_car`, `placa`) VALUES
(1, '1', 'Nenhum', 'Nenhum', 0, 'Nenhuma', '000-000'),
(2, '2', 'Volkswagen', 'Fox Plus 1.0Mi/ 1.0Mi Total Flex 8V 4P', 2022, 'Azul', 'AAA-2222'),
(3, '1', 'Nenhum', 'Nenhum', 0, 'Nenhuma', '000-000'),
(4, '1', 'Nenhum', 'Nenhum', 0, 'Nenhuma', '000-000'),
(5, '1', 'Fiat', '147 C/ Cl', 2022, 'Branco', 'AAA-1000'),
(6, '1', 'Nenhum', 'Nenhum', 0, 'Nenhuma', 'AAA-0000');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_veiculo_visitante`
--

CREATE TABLE `tb_veiculo_visitante` (
  `id_carro` int(11) NOT NULL,
  `id_dono` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `marca` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `modelo` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Extraindo dados da tabela `tb_veiculo_visitante`
--

INSERT INTO `tb_veiculo_visitante` (`id_carro`, `id_dono`, `marca`, `modelo`, `ano_car`, `cor_car`, `placa`) VALUES
(1, '1', 'Nenhum', 'Nenhum', 0, 'Nenhuma', 'AAA-0000'),
(2, '2', 'Volkswagen', 'Fox Plus 1.0Mi/ 1.0Mi Total Flex 8V 4P', 2022, 'Azul', 'AAA-2222'),
(3, '3', 'Nenhum', 'Nenhum', 0, 'Não Consta', 'AAA-0000');
...
CREATE TABLE `tb_visitantes` (
  ...
  `posto` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `tb_visitantes` (`visit_id`, `nome`, `posto`, `cpf`, `telefone`) VALUES
(1, 'Teste 1', 'EB - Cel', '111.111.111-11', '(11) 1111-11111'),
(2, 'Teste 2', 'EB - Cel', '222.222.222-22', '(22) 22222-2222'),
(3, 'Teste 3', 'EB - Cel', '333.333.333-33', '(33) 33333-3333');
...
CREATE TABLE `tb_visitas` (
  ...
  `id_visitante` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `destino` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cracha` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `entrada` date NOT NULL,
  `entradaHr` time NOT NULL,
  `saida` date NOT NULL,
  `saidaHr` time NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `tb_visitas` (`id_visitas`, `id_visitante`, `destino`, `cracha`, `entrada`, `entradaHr`, `saida`, `saidaHr`) VALUES
(1, '1', 'Teste 1', '01', '2022-12-01', '09:46:51', '2022-12-01', '09:57:06'),
(2, '2', 'Teste 2', '02', '2022-12-01', '09:47:35', '2022-12-01', '00:00:00'),
(3, '1', 'Teste 1-1', '011', '2022-12-01', '09:49:33', '2022-12-01', '09:57:14'),
(4, '1', 'Teste 1-2', '0111', '2022-12-01', '09:49:53', '2022-12-01', '00:00:00'),
(5, '1', 'Teste 1-3', '0111', '2022-12-01', '09:51:23', '2022-12-01', '00:00:00'),
(6, '1', 'wq', '2312', '2022-12-01', '11:21:04', '2022-12-01', '00:00:00');
...
--
-- Índices para tabela `tb_endereco_visitante`
--
ALTER TABLE `tb_endereco_visitante`
  ADD PRIMARY KEY (`id_end`);

--
-- Índices para tabela `tb_ex_veiculo`
--
ALTER TABLE `tb_ex_veiculo`
...
--
-- Índices para tabela `tb_veiculo_visitante`
--
ALTER TABLE `tb_veiculo_visitante`
  ADD PRIMARY KEY (`id_carro`);

--
-- Índices para tabela `tb_visitantes`
--
...
--
-- AUTO_INCREMENT de tabela `tb_endereco_visitante`
--
ALTER TABLE `tb_endereco_visitante`
  MODIFY `id_end` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de tabela `tb_ex_veiculo`
--
ALTER TABLE `tb_ex_veiculo`
  MODIFY `id_carro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1784;

--
-- AUTO_INCREMENT de tabela `tb_posto`
--
ALTER TABLE `tb_posto`
  MODIFY `id_posto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
...
--
-- AUTO_INCREMENT de tabela `tb_veiculo_visitante`
--
ALTER TABLE `tb_veiculo_visitante`
  MODIFY `id_carro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de tabela `tb_visitantes`
--
ALTER TABLE `tb_visitantes`
...
--
ALTER TABLE `tb_visitas`
  MODIFY `id_visitas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
