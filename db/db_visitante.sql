...
--
-- Host: 127.0.0.1
-- Tempo de geração: 31-Jan-2024 às 14:53
...
CREATE DATABASE IF NOT EXISTS db_visitante;
USE db_visitante;
-- --------------------------------------------------------
...
CREATE TABLE `tb_endereco` (
  ...
  `num_casa` varchar(100) DEFAULT NULL,
  `cidade` varchar(300) DEFAULT NULL,
  `uf` varchar(100) DEFAULT NULL,
  `cep` varchar(15) NOT NULL,
  `ibge` int(50) NOT NULL,
  `dono_resid` varchar(255) NOT NULL,
...
(11, 'Rua da Aman', 'Castelo Branco', '01', 'Resende', 'RJ', '27.536-280', 3304201, '10', 0),
(12, 'Rua da Aman', 'Castelo Branco', '02', 'Resende', 'RJ', '27.536-280', 3304201, '9', 0),
(13, 'Rua da Aman', 'Castelo Branco', '3232', 'Resende', 'RJ', '27.536-280', 3304201, '11', 0),
(14, 'Rua da Aman', 'Castelo Branco', '01', 'Resende', 'RJ', '27.536-280', 3304201, '10', 0);
...
(9, 'Rua da Aman', 'Castelo Branco', '02', 'Resende', 'RJ', '27.536-280', 3304201, '9'),
(10, 'Rua da Aman', 'Castelo Branco', '01', 'Resende', 'RJ', '27.536-280', 3304201, '10'),
(11, 'Rua da Aman', 'Castelo Branco', '3232', 'Resende', 'RJ', '27.536-280', 3304201, '11'),
(12, 'Rua da Aman', 'Castelo Branco', '1000', 'Resende', 'RJ', '27.536-280', 3304201, '12');
...
CREATE TABLE `tb_veiculo` (
  `id_carro` int(11) NOT NULL,
  `id_dono` varchar(250) NOT NULL,
  `marca` varchar(250) NOT NULL,
  `modelo` varchar(250) NOT NULL,
  `ano_car` int(10) NOT NULL,
  `cor_car` varchar(60) NOT NULL,
...
(11, '10', 'Nenhum', 'Nenhum', 0, 'Nenhuma', '000-000'),
(12, '9', 'Citroen', 'C4 Glx 1.6 Flex 16V 5P Mec.', 2022, 'Branco', 'A1A1A1A1'),
(13, '11', 'Teste', 'Teste', 2021, 'Azul', '000-000'),
(14, '10', 'Citroen', 'Ax Gti', 2022, 'Branco', '000-2121');
...
(9, '9', 'Citroen', 'C4 Glx 1.6 Flex 16V 5P Mec.', 2022, 'Branco', 'A1A1A1A1'),
(10, '10', 'Citroen', 'Ax Gti', 2022, 'Branco', '000-2121'),
(11, '11', 'Teste', 'Teste', 2021, 'Azul', '000-000'),
(12, '12', 'Toyota', 'Avalon Xls 3.0', 2000, 'Azul', 'AAA-0222');
...
(9, 'Mario Morais', 'EB - Visitante', '111.111.111-11', '(11) 11111-1111'),
(10, 'Patrick Monteiro', 'EB - Cap', '222.222.222-22', '(22) 22222-2222'),
(11, 'Marcos Antonio', 'CB - Cel', '333.333.333-33', '(33) 33333-3333'),
(12, 'Pedro Henrique', 'EB - Cel', '444.444.444-44', '(44) 4444-44444');
...
(11, '10', 'Aman', '012', '2024-01-31', '10:31:29', '2024-01-31', '10:46:31'),
(12, '9', 'AMAN', '0222', '2024-01-31', '10:36:29', '2024-01-31', '10:49:17'),
(13, '11', 'AMAN', '222', '2024-01-31', '10:44:30', '2024-01-31', '10:49:34'),
(14, '10', 'AMAN', '2022', '2024-01-31', '10:48:01', '2024-01-31', '10:49:36');
...
--
ALTER TABLE `tb_ex_veiculo`
  MODIFY `id_carro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1785;
...
--
ALTER TABLE `tb_visitas`
  MODIFY `id_visitas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
COMMIT;
